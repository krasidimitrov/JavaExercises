...
public class DatabaseHelper {
  ...
  public String executeQueryWithResult(String query, Object... params) {
    ...
    String data = "";
    try {
      connection =connectionProvider.get(); //dataSource.getConnection();
      PreparedStatement preparedStatement = connection.prepareStatement(query);
...
//  public void executeQueryForTransaction(Connection connection, String query, Object... params) {
//    try {
//
//      PreparedStatement preparedStatement = transactionConnection.prepareStatement(query);
//      fillParams(preparedStatement, params);
//      preparedStatement.execute();
//
//    } catch (SQLException e) {
...
//  }
//
//  public void executeWithTransaction(TransactionExecutor transactionFoo) {
//    try {
//      transactionConnection = dataSource.getConnection();
//      transactionConnection.setAutoCommit(false);
//      transactionFoo.execute(transactionConnection);
